...
func TestCanHandleAndAccept(t *testing.T) {
	...
	f := &mesosFactory{
		...
		fsInfo:             nil,
		ignoreMetrics:      nil,
		client:             mockMesosSlaveClient(testContainers, nil),
	}
	for k, v := range map[string]bool{
		"/mesos/04e20821-67d3-4bf7-96b4-7d4495f50b28":                                                                                                                   true,
		"/system.slice/var-lib-mesos-provisioner-containers-04e20821-d67d3-4bf7-96b4-7d4495f50b28-backends-overlay-rootfses-6d97be39-7359-4bb7-a46b-e55c6771da81.mount": false,
	} {
