...
func TestHandler(t *testing.T) {
	...
	for _, ts := range []testCase{
		{
			mockMesosSlaveClient(nil, fmt.Errorf("no client returned")),
		...
		{
			mockMesosSlaveClient(map[string]*containerInfo{"04e20821-67d3-4bf7-96b4-7d4495f50b28": {cntr: &mesosContainer{Status: status{ExecutorPID: 123}}}}, nil),
			"/mesos/04e20821-67d3-4bf7-96b4-7d4495f50b28",
			nil,
			nil,
			&containerlibcontainer.CgroupSubsystems{},
